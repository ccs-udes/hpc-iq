...
Pour obtenir l'accès à la Grappe IQ :
...
de la Grappe IQ. Votre compte CCDB vous donnera aussi accès aux grappes de
calcul de l’Alliance. Si vous n’êtes pas un professeur ou une professeure, votre
accès doit être parrainé. Demandez à votre superviseur son CCRI (identifiant de
rôle, au format abc-123-45) dans CCDB. Vous aurez besoin de cette information
pour identifier votre parrain lors de votre inscription.

Authentification multifacteur
-----------------------------

L’authentification multifacteur est obligatoire sur la Grappe IQ et sur toutes
les grappes de l’Alliance. Une fois votre compte CCDB activé, vous devez ajouter
un second facteur d’identification avant de pouvoir vous connecter aux grappes.
...
..
    ...
    donner accès), vous pouvez obtenir un compte restreint à la Grappe IQ.
